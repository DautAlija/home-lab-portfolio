...
| Victim | Windows 10/11 | Primary target |
| Web Target | DVWA | Web application attacks |
| Firewall | OPNSense | Network control & IDS/IPS |
...
|---|---|---|---|
| 01 | [OPNSense Firewall & IDS/IPS Lab](./standalone-projects/01-opnsense-ids-ips-firewall/) | Network security, firewall config, Suricata, IDS/IPS | 🔄 In Progress — Parts 1 & 2 Complete |
